...
-- Copiando dados para a tabela bermar.addresses: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `addresses` DISABLE KEYS */;
REPLACE INTO `addresses` (`id`, `number`, `street`, `district`, `zipcode`, `city`, `state`, `complement`, `enterprise_id`, `created_at`, `updated_at`, `city_id`) VALUES
...
-- Copiando dados para a tabela bermar.categories: ~2 rows (aproximadamente)
...
REPLACE INTO `categories` (`id`, `name`, `created_at`, `updated_at`, `slug`) VALUES
	...
	(3, 'Cilindros', '2022-07-07 21:22:18', '2022-07-07 21:22:35', 'cilindros');
...
REPLACE INTO `chat` (`id`, `status`, `warranty_id`, `enterprise_id`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 1, 2, '2022-07-18 20:40:22', '2022-07-18 20:40:24');
...
REPLACE INTO `chat_messages` (`id`, `message`, `file`, `chat_id`, `created_at`, `updated_at`, `user_id`) VALUES
	(65, 'Olá quero abrir um chamado.', NULL, 1, '2022-07-26 17:12:05', '2022-07-26 17:12:05', 2),
	(66, 'ok, por favor envie fotos do produto.', NULL, 1, '2022-07-26 17:12:24', '2022-07-26 17:12:24', 1),
	(67, NULL, '62e02096e3782_&&_b1.jpg', 1, '2022-07-26 17:12:54', '2022-07-26 17:12:54', 2),
	(68, 'ok, vou colocar a assistencia tecnica na conversa', NULL, 1, '2022-07-26 17:13:19', '2022-07-26 17:13:19', 1),
	(69, 'A Assistencia Tecnica foi inserida no chat.', NULL, 1, '2022-07-26 17:14:05', '2022-07-26 17:14:05', 0),
	(70, 'Olá, vamos dar continuidade.', NULL, 1, '2022-07-26 17:17:06', '2022-07-26 17:17:06', 3);
...
-- Copiando dados para a tabela bermar.enterprises: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela bermar.enterprise_types: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela bermar.migrations: ~32 rows (aproximadamente)
...
REPLACE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(27, '2022_07_16_133216_warranty', 9),
...
-- Copiando dados para a tabela bermar.personal_access_tokens: ~27 rows (aproximadamente)
...
REPLACE INTO `products` (`id`, `name`, `description`, `datasheet`, `image`, `price`, `status`, `created_at`, `updated_at`, `deleted_at`, `category_id`, `slug`, `width`, `weight`, `length`, `height`, `video`) VALUES
	(5, 'AMACIADOR E PREPARADOR DE CARNES EM AÇO INOX COM BOCAL DE 175MM- BM 34 NR PF – BIVOLT', '<p>Teste</p><ol><li>	teste</li><li>teste</li><li>teste</li><li>tete5</li></ol>', NULL, NULL, 5000.00, 1, NULL, NULL, NULL, 2, 'amaciador_e_preparador_de_carnes_em_aco_inox_com_bocal_de_175mm_bm_34_nr_pf_bivolt', 20.00, 30.00, 50.00, 50.00, 'https://www.youtube.com/embed/RK3ZOjwYwto'),
	(6, 'produto 2', '<p>Teste</p>', '<p>teste</p>', NULL, 500.00, 1, NULL, NULL, NULL, 2, 'produto_2', 50.00, 50.00, 50.00, 50.00, NULL),
	(10, 'produto 3', '<p>teste1	</p>', '<p>teste2</p>', NULL, 900.00, 1, NULL, NULL, NULL, 2, 'produto_3', 50.00, 50.00, 50.00, 50.00, NULL),
	(11, 'produto 4', '<p>teste</p>', '<p>teste</p>', NULL, 500.00, 1, NULL, NULL, NULL, 2, 'produto_4', 5.00, 5.00, 50.00, 50.00, NULL),
	(12, 'produto 5', '<p>teste1	</p>', '<p>teste2</p>', NULL, 900.00, 1, NULL, NULL, NULL, 2, 'produto_5', 50.00, 50.00, 50.00, 50.00, 'https://www.youtube.com/embed/Uw8RDwpdEig'),
	(13, 'Produto 6', '<h1>TESTANDO</h1><p><br></p><ol><li>TESTE1</li><li>TESTE2</li><li>TESTE3</li></ol><p><br></p>', '<p>TESTE</p><ul><li>TESTE</li><li>TESTE</li><li>TESTE</li></ul>', NULL, 5000.00, 1, NULL, NULL, NULL, 2, 'produto_6', 50.00, 50.00, 50.00, 50.00, 'https://www.youtube.com/embed/-hTwpgmEats');
...
-- Copiando dados para a tabela bermar.sale_orders: ~3 rows (aproximadamente)
...
REPLACE INTO `sale_orders` (`id`, `user_id`, `enterprise_id`, `status`, `status_payment`, `status_delivery`, `created_at`, `updated_at`) VALUES
	(3, 2, 1, 1, 1, 1, '2022-07-15 22:54:29', '2022-07-15 22:54:29'),
...
-- Copiando dados para a tabela bermar.sale_order_items: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela bermar.token_delivery: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `token_delivery` DISABLE KEYS */;
REPLACE INTO `token_delivery` (`id`, `token`, `created_at`, `updated_at`) VALUES
	(3, '5QVshGkYZmK6tyoyVeP_DHhfGk6UMWTIdguF3xLWbbw94qVCTcdHhZ_UJjWodDBSHywouPNadbg7zD8Eg1qKUlvImT92BVswvnTl-vhwFnN_OAuQ3YD_YUYLLgQX7Bu69pM8_Jh8EBbwdFtsnmdSk1VXJIwOqgsapJncsrLp84ny6poK07Got_j6RJ-uskPLjE6D4qMjvZmtV7LLKMWRYwvVqkElQPeeesKLARuPIoBGJM0fRvIzN7s3dm4_zjDzu6skx3Z51i3YGKaFYhTPX-ri0JTpy60KAwf4bZUonF24FOh03bVVAl-sek1EeE-Ti9e1iMjtdVWiFBXH1GhhsX2TkFGM9DKbfZC-CjiMNDpH9gEW1G5aDWpKOhSY3Gs187IwM-HGNCNo5XffDGiUnS2j6P4P1TpS1seKlISgHXj3J6lH23YHlUY-_TSuDh-vcMkMe8HsYBu7XZAKnQKgwA', '2022-07-02 19:15:03', '2022-07-21 23:21:37');
...
CREATE TABLE IF NOT EXISTS `warranties` (
  ...
  `enterprise_id` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `warranties_sale_order_id_foreign` (`sale_order_id`),
  KEY `warranties_enterprise_id_foreign` (`enterprise_id`),
  CONSTRAINT `warranties_enterprise_id_foreign` FOREIGN KEY (`enterprise_id`) REFERENCES `enterprises` (`id`),
  CONSTRAINT `warranties_sale_order_id_foreign` FOREIGN KEY (`sale_order_id`) REFERENCES `sale_orders` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela bermar.warranties: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `warranties` DISABLE KEYS */;
REPLACE INTO `warranties` (`id`, `status`, `sale_order_id`, `created_at`, `updated_at`, `enterprise_id`) VALUES
	(1, 1, 5, '2022-07-16 12:07:53', '2022-07-25 19:32:29', 3);
