...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <section class="mb-5">
        <div>
            <div>
                ...
                <h4 class=" mt-3 mb-3  text-center ">Busque assistência por Estado.</h4>
    ...
    function selectState(texto_busca = null, paginacao = 0) {
        ...
        var url = "/api/get-companies-state/assistencias/"+uf+'?page='+paginacao;
        if(texto_busca){
            var url = "/api/get-companies-state/assistencias/"+uf+"/"+texto_busca+'?page='+paginacao;
        }
